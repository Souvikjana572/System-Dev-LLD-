// This code demonstrates the Dependency Inversion Principle (DIP) by decoupling high-level modules from low-level modules through the use of an abstraction (interface).
#include <iostream>
using namespace std;
