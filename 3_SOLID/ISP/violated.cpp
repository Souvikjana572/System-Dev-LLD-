// This code demonstrates a violation of the Interface Segregation Principle (ISP) in C++.
// The Shape interface forces all shapes to implement both area() and volume(), even though 2D shapes don't have a volume, leading to unnecessary methods and potential runtime errors.         
#include <iostream>
#include <stdexcept>
