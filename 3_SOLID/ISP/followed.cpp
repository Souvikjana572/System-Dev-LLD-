// This code demonstrates the Interface Segregation Principle (ISP) by defining separate interfaces for 2D and 3D shapes, allowing classes to implement only the relevant interface.
#include <iostream>
